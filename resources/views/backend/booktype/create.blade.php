			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<div class="row">
								<label class="control-label col-md-6 col-sm-6 col-xs-12" >新增圖書類型</label>
							</div>
						</div>
	
						<div class="x_content">
							<div class="col-md-8 col-sm-8 col-xs-12">
								<form action="{{route('booktype.store')}}" method="POST" class="form-horizontal form-label-left" id="createForm">
									...
									<div class="form-group {{ $errors->has('borrow_day') ? ' has-error' : '' }}" >
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" class="form-control" placeholder="請輸入天數" name="borrow_day" value="{{old('borrow_day')}}" maxlength="2" />
