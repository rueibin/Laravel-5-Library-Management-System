			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<div class="row">
								<label class="control-label col-md-6 col-sm-6 col-xs-12" >編輯權限</label>
							</div>
						</div>
	
						<div class="x_content">
							<div class="col-md-8 col-sm-8 col-xs-12">
								<form action="{{route('permission.update',$permission->id)}}" method="POST" class="form-horizontal form-label-left" id="createForm">
									...
									<div class="form-group" >
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<select id="select_pid" class="form-control" name="pid" value="{{$permission->pid}}">
									...
									<div class="form-group {{ $errors->has('display_name') ? ' has-error' : '' }}" >
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" class="form-control" placeholder="請輸入權限名稱（中文）" name="display_name"  value="{{$permission->display_name}}" />
									...
									<div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}" >
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" class="form-control" placeholder="請輸入權限" name="name"  value="{{$permission->name}}" />
											@if ($errors->has('name'))	
												<span class="help-block">
									...
									<div class="form-group {{ $errors->has('slug') ? ' has-error' : '' }}" >
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" class="form-control" placeholder="請輸入路由別名" name="slug"  value="{{$permission->slug}}" />
												<span class="help-block">
											@if ($errors->has('slug'))
												<span class="help-block">
									...
									<div class="form-group {{ $errors->has('url') ? ' has-error' : '' }}" >
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<input type="text" class="form-control" placeholder="請輸入url" name="url"  value="{{$permission->url}}" />
											@if ($errors->has('url'))
												<span class="help-block">
									...
									<div class="form-group" >
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											...
											@else
												是<input type="radio" class="flat"  name="menu" value="1"  /> 
												不是<input type="radio" class="flat" name="menu" value="2" checked />
											@endif
										</div>
									</div>
									...
									<div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}" >
										...
										<div class="col-md-8 col-sm-8 col-xs-12">
											<textarea  style="width:100%;height:100px;" name="description" placeholder="請輸入備註" value="{{$permission->url}}"></textarea>
