		...
		<div class="">
			<div class="page-title">
				<div class="title_left">
					<h2>圖書借還管理 / <a href="{{route('borrow.index')}}">圖書借閱</a></h2>
				</div>
			...
			<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<div class="row">
									<label class="control-label col-md-6 col-sm-6 col-xs-12" >圖書借閱</label>
								</div>
		...
		$('#book_barcode').change(function () { 
			...
			$.ajax({
				...
				$.each( data, function( key, value ) {
					...
					book_rows=book_rows + '@permission('borrow-borrow')<td data-id="'+ value['id'] +'"><button type="button" class="btn btn-success item-add">借閱</button></td>@endpermission';
					book_rows=book_rows + '</tr>';
